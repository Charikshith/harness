...
artifact: "harness/memory/<slug>.md"
...
<!-- One lesson per file. Copy this shape. Keep it short — if it needs scrolling, it is
     probably two lessons. Remember to append a pointer line to harness/memory/index.md; the
...
<!-- Do NOT record here:
     ...
     - status or progress — that belongs in harness/progress.md

...
| [dreaming-pattern.md](dreaming-pattern.md) | pattern | memory, dreaming, curation, staleness, review, out-of-band | Out-of-band batch curation of the memory store: threshold-gated proposals with evidence, propose-never-apply, bounded review queue |

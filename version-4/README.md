...
|---|---|---|
| v4 (current, 0.4.4) | `version-4/` | `harness/` install layout — three files at the project root, all harness state under `harness/`; layout-aware resolvers with backward compatibility for the flat layout |

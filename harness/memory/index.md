...
- [git reset --hard discards uncommitted work, not just the target commit](reset-hard-discards-uncommitted-work-too.md) — check git status for unrelated uncommitted edits before running it
